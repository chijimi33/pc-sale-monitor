...
# A zero Task Scheduler limit permits healthy long inference; agent.py watches
# actual progress. IgnoreNew plus worker.lock still prevent concurrent workers.
